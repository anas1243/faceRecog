...
public class Classifier {
    ...
    static Classifier getInstance(AssetManager assetManager,
                                  int inputHeight,
                                  int inputWidth, TextToSpeech textToSpeech) throws Exception {
            ...
            for (Pair face : faces) {
                ...
                if (prob > 0.5) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        ...
                        mtextToSpeech.speak(name,TextToSpeech.QUEUE_FLUSH,null,null);
                    } else {
                        mtextToSpeech.speak(name, TextToSpeech.QUEUE_FLUSH, null);
                    }
                } else {
